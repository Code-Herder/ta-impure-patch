...
| 6 | **G13 — full scene takeover**: terrain tiles → GL (TNT tile atlas), features → GL sprites, projectiles/explosions native, fog native; UI/minimap stay engine-side; then free zoom/camera | engine software frame = data only |
