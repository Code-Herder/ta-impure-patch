...
sites, deferred tracking drained within a frame or two, queue high-water 3, overflow 0, no foreign
thread ever calling; the fights that faulted run clean (the run count is in the gate row).
